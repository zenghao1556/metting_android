...
public class PullToRefreshView extends LinearLayout {
    ...
    private void addHeaderView() {
        ...
        iv_refresh_anim = (ImageView) mHeaderView.findViewById(R.id.iv_refresh_anim);
        animationDrawable = (AnimationDrawable) iv_refresh_anim.getBackground();
...
//        mHeaderImageView.setImageResource(R.mipmap.ic_rufresh_down);
//        mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
...
//        mHeaderTextView.setVisibility(VISIBLE);
    ...
    public void onFooterRefreshComplete() {
        ...
        mFooterImageView.setImageResource(R.mipmap.ic_rufresh_down);
        mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
